...
- **src/**: 22-module flat Python stdlib library — all modules at `src/*.py` (db, router, overrides, confidence, graduate, interview, worktree, circuit_breaker, handoff, sync, documents, git_utils, response_analyzer, progress, exit_tracker, loop, experiment, convergence, fitness, self_assessment, session_miner, task_graph)
